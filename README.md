...
A análise foi realizada utilizando o Tableau para criação das visualizações e do dashboard interativo.

## 🎯 Objetivos

O objetivo deste projeto foi analisar os vídeos em alta no YouTube para identificar padrões de popularidade entre diferentes países.

A análise e o dashboard foram desenvolvidos para responder às seguintes perguntas:

- Quais categorias de vídeo aparecem em alta com maior frequência?
- Como essas categorias estão distribuídas entre as diferentes regiões?
...
A análise explorou a frequência das categorias, sua distribuição entre os mercados e as diferenças de popularidade entre os Estados Unidos e outras regiões.
...
O resultado da análise foi apresentado em um dashboard interativo desenvolvido no Tableau Public.

👉 [Acessar o dashboard interativo](https://public.tableau.com/views/Projeto_Youtube_17864619061670/DashboardYouTubeTrending?:language=pt-BR&publish=yes&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)

## 📑 Apresentação

👉 [Acessar a apresentação](./apresentacao-youtube.pdf)
